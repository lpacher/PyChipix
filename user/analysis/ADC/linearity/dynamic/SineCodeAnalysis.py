...
#----------------------------------------------------------------------------------------------------
# {Trace}
# [Filename]      SineCodeAnalysis.py
# [Project]       CHIPIX65 pixel ASIC demonstrator
# [Author]        Luca Pacher - pacher@to.infn.it
#                 Pietro Mazzucchelli - pietro.mazzucchelli@edu.unito.it
# [Version]       1.0
# [Language]      Python/ROOT
# [Created]       Sep 4, 2017
# [Description]   Computes DNL/INL histograms from .root file containing ADC sampled data
#                 and assuming a sine input waveform
#
# [Notes]         Usage:
#
#                 python -i SineCodeAnalysis.py /path/to/sample.root
# {Trace}
#----------------------------------------------------------------------------------------------------
...
## in case of a sine input waveform the PDF of ADC codes involves arcsines
def pdf(x, par) :
	...
	return norm*(math.asin((code-offset)/amplitude) - math.asin((code-1-offset)/amplitude))
